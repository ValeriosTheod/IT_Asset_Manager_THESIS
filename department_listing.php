...
<div class="datatable-container">
    ...
    <div class="header-tools">
      ...
      <button style="margin-left: auto;" onclick="exportme('department')">Export</button>
    </div>
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while($row = mysqli_fetch_assoc($result)) {
            if ($index <= $limit2 && $index >= $limit1){
              ...
              <td>'.$row['depa_id'].'</td>
              <td>'.$row['depa_name'].'</td>
              <td><img class="iconimg" src="./icons/delete.png" onclick=\'deleteUser("'.$row['depa_id'].'")\' alt="edit"></td>
      ...
      <div class="pages">
        <ul>
          <?php
            ...
            for ($x = 1; $x <= $pages; $x++) {
              if ($x == $page){
                echo "<li><button onclick=\"window.location.href='department_listing.php?page=".$x."'\"><span class=\"active\">".$x."</span></button></li>";
           
              }else{
              echo "<li><button onclick=\"window.location.href='department_listing.php?page=".$x."'\">".$x."</button></li>";
              echo "\n";
              }
            }
          ?>
  ...
  <script>
    ...
    function searchAsset() {
      ...
      for (i = 0; i < tr.length; i++) {
        ...
        if (!filter || filter === ""){
          window.location.href = "./department_listing.php?page="+<?php echo $page ?>;
          return;
        }
      }
    }
